...
<script lang="ts">
  ...
  /**
   * The height of the iso triangle. The left and right faces will be this tall.
   * The overall height of the iso triangle will be this value plus half the size value.
   *
   * #phaserDefault 32
   * @type {number}
   */
  ...
  /**
   * The width of the iso triangle in pixels.
   * The left and right faces will be exactly half this value.
   *
   * #phaserDefault 48
   * @type {number}
   */
  ...
  export let instance = new GameObjects.IsoTriangle(
    scene,
    x,
    y,
    size,
  ...
  $: shouldApplyProps(reversed) && instance.setReversed(reversed)
